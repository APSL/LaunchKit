...
var IPHONE_8PLUS = 'iphone8plus';
var IPHONE_X = 'iphonex';
var IPAD = 'ipad';
...
var IOS = [
  ...
  {
    name: IPHONE_8PLUS,
    properName: 'iPhone 8 Plus',
    filenamePrefix: '5.5-inch (iPhone 8+)',
    type: 'phone',
    overrideName: 'iphone736',
    ...
    portrait: {
      ...
      screenTop: 137 / 1024,
      screenWidth: 422 / 588,
      screenHeight: 751 / 1024,
      white: { src: '/__static__/devices/iPhone8PlusSpaceGray.png' },
      black: { src: '/__static__/devices/iPhone8PlusSpaceGray.png' },
      gold: { src: '/__static__/devices/iPhone8PlusSpaceGray.png' },
      rose: { src: '/__static__/devices/iPhone8PlusSpaceGray.png' }
    },
    landscape: {
      width: 736,
      height: 414,
  ...
  },
  {
    name: IPHONE_X,
    properName: 'iPhone X',
    filenamePrefix: '5.8-inch (iPhone X)',
    type: 'phone',
    overrideName: 'iphone812',
    ...
    portrait: {
      ...
      screenWidth: 940 / 1151,
      screenHeight: 1669 / 2285,
      white: { src: '/__static__/devices/iPhoneXSilver.png' },
      black: { src: '/__static__/devices/iPhoneXSilver.png' },
      gold: { src: '/__static__/devices/iPhoneXSilver.png' },
      rose: { src: '/__static__/devices/iPhoneXSilver.png' }
    },
    landscape: {
      width: 736,
      height: 414,
...
module.exports = {
  ...
  screenshotCanvasWrappersInContainer: function(
    $container,
    platform,
    orientation
  ) {
